...
def textmining():
	...
	if(neg > pos):
		...
		message = client.messages \
								.create(
										body = "Hello There, We are here to inform you that You have detection Depression ! So We request you to watch this Video To get Some Positive Vibes. \nVideo Link : https://www.youtube.com/watch?v=2UtwSI7lgkQ\n\nRegards Depression Detection Project",
										from_='+19088679123',
										to="+919075517351"
									)
	else:
